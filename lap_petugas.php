...
foreach ($query as $r) {
  ...
  <td>'.$r["tempat_lahir_petugas"].', '.format_indo($r["tgl_lahir_petugas"]).'</td>
  ...
  if ($r["foto_petugas"] == "-") {
    ...
    $content .= '<td><img src="assets/dist/img/'.$r["foto_petugas"].'" width="80"></td>';
...
$html2pdf->output('Laporan data petugas.pdf');
