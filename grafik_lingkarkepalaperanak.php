...
<h4 class="font-weight-bold text-center">Grafik Perkembangan Lingkar Kepala <?= $pecah["nama_anak"]; ?></h4>
...
<script>
  ...
  var speedData = {
    ...
    datasets: [{
      label: "Perkembangan lingkar Kepala Anak",
      data: [<?= $lk_peranak; ?>],
      borderColor: 'orange',
...
<script>
  function PrintImage() {
    ...
    var win = window.open();
    win.document.write("<h3>Grafik Perkembangan Lingkar Kepala <?= $pecah['nama_anak']; ?></h3>");
